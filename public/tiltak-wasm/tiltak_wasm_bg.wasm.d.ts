...
export const annotate_ptn: (a: number, b: number, c: number) => [number, number, number, number];
export const is_tak: (a: number, b: number, c: number) => [number, number, number];
export const is_tinue: (a: number, b: number, c: number, d: number) => [number, number, number];
