...
declare interface InitOutput {
  ...
  readonly _dyn_core__ops__function__Fn__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hc05d97af1d1fea66: (a: number, b: number, c: number, d: number) => void;
  readonly closure22_externref_shim: (a: number, b: number, c: any, d: any) => void;
