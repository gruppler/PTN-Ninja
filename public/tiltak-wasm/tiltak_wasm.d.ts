...
declare interface InitOutput {
  ...
  readonly closure61_externref_shim: (a: number, b: number, c: any) => void;
  readonly _dyn_core__ops__function__Fn__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h2e4496cc7291602a: (a: number, b: number, c: number, d: number) => void;
  readonly closure21_externref_shim: (a: number, b: number, c: any, d: any) => void;
