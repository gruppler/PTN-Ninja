<template>
  <smooth-reflow>
    <div v-if="error" class="text-negative" :class="contentClass">
      {{ formatError(error) }}
    </div>
    <div v-if="success" class="text-positive" :class="contentClass">
      {{ formatSuccess(success) }}
    </div>
    <div v-if="warning" class="text-warning" :class="contentClass">
      {{ formatWarning(warning) }}
    </div>
    <div v-if="hint" :class="contentClass">
      {{ formatHint(hint) }}
    </div>
  </smooth-reflow>
</template>
